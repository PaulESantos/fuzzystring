...
backend with an expanded compiled 'C++' execution path for row
expansion, binding, and result assembly, plus adaptive candidate
planning for efficient processing of large datasets. Ideal for matching
