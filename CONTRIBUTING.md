...
This outlines how to propose a change to fuzzystring. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("PaulESantos/fuzzystring", fork = TRUE)`.
...
Please note that the fuzzystring project is released with a [Contributor
Code of
Conduct](https://paulesantos.github.io/fuzzystring/CODE_OF_CONDUCT.md).
