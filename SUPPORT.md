...
Thanks for using fuzzystring! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/PaulESantos/fuzzystring/issues/new).
...
requests](https://github.com/PaulESantos/fuzzystring/issues) to make
