...
**fuzzystring** provides fast, flexible fuzzy string joins for data frames using approximate string matching. Built on top of `data.table` and `stringdist`, it uses a broader compiled C++ backend for row expansion, row binding, and result assembly, while adaptive candidate planning reduces unnecessary distance evaluations before calling `stringdist`.
